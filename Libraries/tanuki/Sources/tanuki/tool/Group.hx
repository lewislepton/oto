...
typedef Group = Pool<Object>

// class Group {
// 	public var components:Map<String, Object>;
...
//   public function addComponent(object:Object):Bool{
...
//     trace("Object already exists :" + object.name);
//     return false;
//   }
...
// // class Group {
// // 	private var entities:Array<Object>;
// // 	public var max:Int;
...
// // 	// public function add(object:Object, pos:Int = -1):Void {
...
// // 	public function removeEntity(object:Object, splice:Bool = false):Object {
// //     entities.remove(object);
// // 		var index = entities.indexOf(object);
...
// // 	public function forEachActive(action:Object -> Void){
// // 		for (m in entities){
// // 			if (m != null && m.active){
// // 				action(m);
// // 			}
